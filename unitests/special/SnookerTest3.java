...
/**
 * Test rendering an imagea
 *
 */
public class SnookerTest3 {
    /**
     * Image writer for this test
     */
    private final ImageWriter imageWriter = new ImageWriter("teapot - without adaptive", 1200, 1200);

    /**
     * The scene of tea pot
     */
     ...
     */
    private final Camera camera = new Camera.Builder()
            .setLocation(new Point(0, 0, -1500))
     ...
     * Teapot's color
     */
    private static final Color color = new Color(255, 162, 61);
    /**
     * Teapot's material
     */
     ...
     * ball's color 1
     */
    private static final Color ballColor1 = new Color(153, 255, 61);

    /**
     * ball's color 2
     */
    private static final Color ballColor2 = new Color(105, 242, 255);

    /**
     * ball's material 1
     */
    private static final Material ballMaterial1 = new Material().setkD(new Double3(0.5)).setkS(new Double3(0.5)).setnShininess(60);

    /**
     * ball's material 2
     */
    private static final Material ballMaterial2 = new Material().setkD(new Double3(0.5)).setkS(new Double3(0.5)).setnShininess(60);

    /**
     * points to define the teapot
     */
    ...
    public void teapot() {
        ...
        scene.lights.add(new PointLight(new Color(120, 120, 120), new Point(200, 0, -100)).setKq(0.000001));

        scene.geometries.add(
                new Plane(new Point(1, -40, 0),
                        new Point(0, -40, 1),
                        new Point(1, -40, 1))
                        .setEmission(new Color(20, 120, 20))
                        .setMaterial(new Material().setkD(new Double3(0.5)).setkS(new Double3(0.5)).setnShininess(100).setKr(0.5))
        );

        // bubble sphere around the spiral
        scene.geometries.add(new Sphere(100,new Point(0, 0, 0))
                .setEmission(new Color(0, 0, 127)).setMaterial(new Material().setkD(new Double3(0.5)).setkS(new Double3(0.5))
                        .setnShininess(100).setKt(0.8)));


        // add ring of balls around the teapot:
        double y = -20;
        double sep = 3;
        for (int i = 0; i < 360; i += 10) {
            double angle = Math.toRadians(i);
            double x = 70 * Math.cos(angle);
            double z = 70 * Math.sin(angle);
            scene.geometries.add(new Sphere(5,new Point(x, y, z))
                    .setEmission(ballColor1).setMaterial(ballMaterial1));

            scene.geometries.add(new Sphere(5,new Point(-x, y, z))
                    .setEmission(ballColor2).setMaterial(ballMaterial2));
